...
from src.pathfinding import heat # Needs 'heat' from pathfinding.py

import pygame
import math
import random
import heapq # ADDED FOR MAX-HEAP LOGIC
...
class Enemy(Prefab):
    ...
    def __init__(self, game, name, x, y):
        ...
        # CRASH FIX: Ensure self.speed and self.health are initialized 
        ...
        # --- TUNING CHANGE: SET SURGE MULTIPLIER TO 2.0x ---
        self.surge_multiplier = 2.0  # 200% speed
        # ----------------------------------------------------
    ...
    def _manage_speed_modifiers(self, delta):
        ...
        if self.speed_modifiers:
            # The top element is the largest negative number (i.e., the largest positive multiplier)
